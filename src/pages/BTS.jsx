...
const BTS = () => {
  return (
    <div id="behind" className="w-full h-auto lg:h-screen bg-[#354F52] flex flex-col lg:flex-row justify-center items-start text-white">
      <img src={bts_res} className="h-64 md:h-80 lg:hidden w-full object-cover" alt="bts" />
      <img src={bts} className="hidden lg:block lg:h-full lg:w-1/3 object-cover" alt="bts" />
      <div className="w-full lg:w-2/3 h-auto lg:h-full flex flex-col justify-center items-center gap-6 md:gap-8 lg:gap-10 text-center px-4 md:px-8 py-12 lg:py-0 order-first lg:order-last">
